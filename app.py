...
if submit:
    ...
    try:
        ...
        st.markdown("---")
        st.subheader("💳 Customer Score Evaluation")

        if CreditScore >= 750:
            st.success("Credit Score Category: 🟦 Excellent – Very Low Risk")
        elif 700 <= CreditScore < 750:
            st.info("Credit Score Category: 🟢 Very Good – Low Risk")
        elif 650 <= CreditScore < 700:
            st.warning("Credit Score Category: 🟡 Good – Medium Risk")
        elif 550 <= CreditScore < 650:
            st.error("Credit Score Category: 🟠 Fair – High Risk")
        else:
            st.error("Credit Score Category: 🔴 Poor – Very High Risk")
